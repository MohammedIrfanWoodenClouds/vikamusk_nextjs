              ...
              <div className="sticky top-24">
                ...
                >
                  ...
                  <div className="relative p-8">
                    ...
                    {/* ── Divider ── */}
                    <div className="border-t border-[#1E4A6B]/80 my-7" />
                    ...
                    <div className="flex items-start gap-4 group/row">
                      ...
                      <div className="flex-1">
                        <p className="text-[10px] font-bold text-[#AFC3D4] uppercase tracking-[0.55px] mb-1.5">UAE Headquarters</p>
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 mt-4 text-[#F5B400] text-[12px] font-bold uppercase tracking-[0.5px] hover:brightness-125 transition-all group/nav"
                        >
                          Navigate to HQ
                          <ArrowUpRight
                            size={14}
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-[#AFC3D4] uppercase tracking-[0.55px] mb-3">Quick Connect</p>
                      <a
                        href="https://wa.me/97174044433"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 bg-white/[0.04] hover:bg-[#25D366]/[0.08] border border-white/10 hover:border-[#25D366]/30 rounded-xl px-4 py-3 transition-all duration-300 group/wa"
                      >
                        <div className="w-9 h-9 rounded-lg bg-[#25D366]/10 border border-[#25D366]/25 flex items-center justify-center shrink-0 transition-all duration-300 group-hover/wa:bg-[#25D366]/20">
                          <svg className="w-[17px] h-[17px] text-[#25D366]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[11px] text-[#AFC3D4]">Typically replies instantly</p>
                        </div>
                        <ArrowUpRight
                          size={15}
                    ...
                    {/* ── Footer trust line ── */}
                    <p className="text-center text-[11px] text-[#AFC3D4]/60 mt-7 tracking-wide">
