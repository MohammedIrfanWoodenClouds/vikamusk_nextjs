...
export default function ProductDetailClient({ 
  ...
  const [product]                           = useState<any>(initialProduct ? normalizeProduct(initialProduct) : null);
  const [models]                            = useState<ProductModel[]>(initialModels || []);
  const [relatedProducts]                   = useState<any[]>(initialRelated ? initialRelated.map(normalizeProduct) : []);
